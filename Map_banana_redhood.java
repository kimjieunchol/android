...
public class Map_banana_redhood extends AppCompatActivity {

    private static MediaPlayer banana;

    Integer[] tileType = {
            R.drawable.no_tile, R.drawable.tile, R.drawable.tile_start, R.drawable.tile_banana, R.drawable.wall_tree, R.drawable.wall_trap, R.drawable.wall_light
    };
    Integer[] mapType = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_banana_redhood);
        ...
        //배경음악 가져오기
        banana = MediaPlayer.create(this, R.raw.banana_sound);
        ...
        dirTop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ImageButton dirButton = new ImageButton(Map_banana_redhood.this);
        ...
        levelBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Map_banana_redhood.this, MainActivity.class);
        ...
        goalImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Map_banana_redhood.this, fruitMain_redhood.class);
                startActivity(intent);
                finish();
            }
        });
