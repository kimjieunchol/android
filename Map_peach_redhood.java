...
public class Map_peach_redhood extends AppCompatActivity {

    private static MediaPlayer peach;

    Integer[] tileType = {
            R.drawable.no_tile, R.drawable.tile, R.drawable.tile_start, R.drawable.tile_peach, R.drawable.wall_tree, R.drawable.wall_trap, R.drawable.wall_light
    };
    Integer[] mapType = {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_peach_redhood);
        ...
        //배경음악 가져오기
        peach = MediaPlayer.create(this, R.raw.peach_sound);
        ...
        dirTop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ImageButton dirButton = new ImageButton(Map_peach_redhood.this);
        ...
        levelBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Map_peach_redhood.this, MainActivity.class);
        ...
        goalImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Map_peach_redhood.this, fruitMain_redhood.class);
                startActivity(intent);
                finish();
            }
        });
