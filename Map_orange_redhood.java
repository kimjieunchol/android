...
public class Map_orange_redhood extends AppCompatActivity {

    private static MediaPlayer orange;

    Integer[] tileType = {
            R.drawable.no_tile, R.drawable.tile, R.drawable.tile_start, R.drawable.tile_orange, R.drawable.wall_tree, R.drawable.wall_trap, R.drawable.wall_light
    };
    Integer[] mapType = {
            R.raw.mapfile1, R.raw.mapfile2, R.raw.mapfile3, R.raw.mapfile4, R.raw.mapfile5
    };

    int mCountWidth = 10; //맵의 가로 갯수
    int mCountHeight = 6; //맵의 세로 갯수
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_orange_redhood);
        ...
        //배경음악 가져오기
        orange = MediaPlayer.create(this, R.raw.orange_sound);
        ...
        baseView.setNumColumns(10); //가로 갯수

        dirLayout = (GridLayout) findViewById(R.id.dirGridLayout);
        dirLayout.setColumnCount(10);
        ...
        dirTop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ImageButton dirButton = new ImageButton(Map_orange_redhood.this);
        ...
        levelBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Map_orange_redhood.this, MainActivity.class);
        ...
        goalImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Map_orange_redhood.this, fruitMain_redhood.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public void printLittleWitch() {
        ...
        int posX = startPosition % 10;
        int posY = startPosition / 10 -1;
        //꼬마 크기
