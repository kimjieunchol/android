...
public class Map_apple_redhood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_apple_redhood);
        ...
        dirTop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ImageButton dirButton = new ImageButton(Map_apple_redhood.this);
        ...
        levelBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Map_apple_redhood.this, MainActivity.class);
...
//음성과 함께 배경에 깔린 팝업을 화면 맨 앞으로 띄운다
        goalImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Map_apple_redhood.this, fruitMain_redhood.class);
                startActivity(intent);
                finish();
            }
        });
